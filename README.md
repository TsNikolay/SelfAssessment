...
[![Skills](https://img.shields.io/badge/Self_Assessment-0&nbsp;/&nbsp;0&nbsp;/&nbsp;731-009933?style=flat-square)](https://github.com/TsNikolay/SelfAssessment/blob/main/Profile/REPORT.md) - The data will appear in the next fill because the winter 2023 template was different from the current one and did not have an automatic estimation function 
